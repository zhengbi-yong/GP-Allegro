...
from urdf_parser_py.urdf import Robot, Box, Sphere, Mesh
    ...
    def __init__(self, urdf_path, contact_points_path, n_surface_points=0, device='cpu'):
        ...
        for link in self.robot.links:
            ...
            if type(collision.geometry) == Mesh:
                ...
                # 构建并打印完整的文件路径
                filename = os.path.join('/home/sisyphus/Allegro/DexGraspNet/grasp_generation/leaphand', collision.geometry.filename)
        ...
        self.adjacency_mask[self.link_name_to_link_index['palm_lower'], self.link_name_to_link_index['pip_4']] = True
        self.adjacency_mask[self.link_name_to_link_index['pip_4'], self.link_name_to_link_index['palm_lower']] = True
